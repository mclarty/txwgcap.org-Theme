...
function genesis_404() {
	...
	echo genesis_html5() ? '<article class="entry">' : '<div class="post hentry">';
		...
		echo '<div class="entry-content">';
                printf( '<h2 class="content-box-red">%s</h1>', apply_filters( 'genesis_404_entry_title', __( 'If you are attempting to access CAP Texas Wing restricted content, <a href="https://www.txwgcap.org/wp-login.php?redirect_to=https%3A%2F%2Fwww.txwgcap.org">click here to login</a>.', 'genesis' ) ) );
			if ( genesis_html5() ) :
